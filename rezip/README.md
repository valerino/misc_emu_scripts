...
usage: /home/valerino/repos/misc_emu_scripts/rezip/rezip.sh -p <path/to/src_zip> [-o destination zip|destination dir (source path basename will be used), default is to overwrite source zip] [-z to unzip individual files and delete the zips] [-i to ignore unzip errors]
